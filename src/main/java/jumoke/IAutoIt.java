...
interface IAutoIt {
     ...
     * @return Returns the value of the previous setting.</br>
     ...
     * @return Success: Returns a string containing the text on the clipboard.</br>
     ...
     * @return Success: Returns a string containing the control handle value. </br>
     ...
     * @param szText    - The text of the window to access.
     * @param szControl - The control to interact with.
     * @return Success: Returns text from a control.</br>
     ...
     * @param szText    - The text of the window to access.
     * @param szControl - The control to interact with.
     * @return Success: Returns the X coordinate of the control.</br>
     ...
     * @param szText    - The text of the window to access.
     * @param szControl - The control to interact with.
     * @return Success: Returns the Y coordinate of the control.</br>
     * Failure: Sets oAutoIt.error to 1.
     * @throws XmlRpcException
     * @throws IOException
     */
     ...
     * @param szText    - The text of the window to access.
     * @param szControl - The control to interact with.
     * @return Success: Returns the width of the control.</br>
     * Failure: Sets oAutoIt.error to 1.
     * @throws XmlRpcException
     * @throws IOException
     */
     ...
     * @param szText    - The text of the window to access.
     * @param szControl - The control to interact with.
     * @return Success: Returns the height of the control.</br>
     * Failure: Sets oAutoIt.error to 1.
     * @throws XmlRpcException
     * @throws IOException
     */
     ...
     * @return Success: The PID of the process that was launched.</br>
     ...
     * @return Success: Returns the X coordinate of the window.</br>
     ...
     * @param szTitle - The title of the window to read.
     * @param szText  - Optional: The text of the window to read.
     * @return Success: Returns the Y coordinate of the window.</br>
     * Failure: Returns numeric 1.
     * @throws XmlRpcException
     * @throws IOException
     */
     ...
     * @param szTitle - The title of the window to read.
     * @param szText  - Optional: The text of the window to read.
     * @return Success: Returns the height of the window.</br>
     * Failure: Returns numeric 1.
     * @throws XmlRpcException
     * @throws IOException
     */
     ...
     * @param szTitle - The title of the window to read.
     * @param szText  - Optional: The text of the window to read.
     * @return Success: Returns the width of the window.</br>
     * Failure: Returns numeric 1.
     * @throws XmlRpcException
     * @throws IOException
     */
