...
public class AutoIt implements IAutoIt {
    ...
    public int controlClick(String szTitle, String szText, String szControl, String szButton, int nNumClicks, int nX, int nY) throws XmlRpcException, IOException {
        Agent.log.info(">> " + "agent = " + agent.getURL() + ", " + "szTitle = " + szTitle + ", " + "szText = " + szText + ", " + "szControl = " + szControl + ", " + "szButton = " + szButton + ", " + "nNumClicks = " + nNumClicks + ", " + "nX = " + nX + ", " + "nY = " + nY);
        Vector<Object> params = new Vector<>();
        params.addElement(Marshal.serialize(szTitle));
        params.addElement(Marshal.serialize(szText));
        params.addElement(Marshal.serialize(szControl));
    ...
    @Override
    public void winActivate(String szTitle, String szText) throws XmlRpcException, IOException {
        ...
        @SuppressWarnings("unused") long ret = (long) Marshal.deserialize(res);
        Agent.log.info("<<");
    }

    @Override
    public int winWaitActive(String szTitle, String szText, long nTimeout) throws XmlRpcException, IOException {
    ...
    @Override
    public int winWaitClose(String szTitle, String szText, long nTimeout) throws XmlRpcException, IOException {
        Agent.log.info(">> " + "agent = " + agent.getURL() + ", " + "szTitle = " + szTitle + ", " + "szText = " + szText + ", " + "nTimeout = " + nTimeout);
        Vector<Object> params = new Vector<>();
        params.addElement(Marshal.serialize(szTitle));
        params.addElement(Marshal.serialize(szText));
    ...
    @Override
    public String winGetText(String szTitle, String szText) throws XmlRpcException, IOException {
        Agent.log.info(">> " + "agent = " + agent.getURL() + ", " + "szTitle = " + szTitle + ", " + "szText = " + szText);
        Vector<Object> params = new Vector<>();
        params.addElement(Marshal.serialize(szTitle));
        params.addElement(Marshal.serialize(szText));
    ...
    @Override
    public String winGetTitle(String szTitle, String szText) throws XmlRpcException, IOException {
        Agent.log.info(">> " + "agent = " + agent.getURL() + ", " + "szTitle = " + szTitle + ", " + "szText = " + szText);
        Vector<Object> params = new Vector<>();
        params.addElement(Marshal.serialize(szTitle));
        params.addElement(Marshal.serialize(szText));
    ...
    @Override
    public int run(String szRun, String szDir, long nShowFlag) throws XmlRpcException, IOException {
    ...
    @Override
    public int winClose(String szTitle, String szText) throws XmlRpcException, IOException {
        Agent.log.info(">> " + "agent = " + agent.getURL() + ", " + "szTitle = " + szTitle + ", " + "szText = " + szText);
        Vector<Object> params = new Vector<>();
        params.addElement(Marshal.serialize(szTitle));
        params.addElement(Marshal.serialize(szText));
    ...
    @Override
    public String controlCommand(String szTitle, String szText, String szControl, String szCommand, String szExtra) throws XmlRpcException, IOException {
    ...
    @Override
    public String controlGetText(String szTitle, String szText, String szControl) throws XmlRpcException, IOException {
        Agent.log.info(">> " + "agent = " + agent.getURL() + ", " + "szTitle = " + szTitle + ", " + "szText = " + szText + ", " + "szControl = " + szControl);
        Vector<Object> params = new Vector<>();
        params.addElement(Marshal.serialize(szTitle));
        params.addElement(Marshal.serialize(szText));
    ...
    @Override
    public int controlFocus(String szTitle, String szText, String szControl) throws XmlRpcException, IOException {
        Agent.log.info(">> " + "agent = " + agent.getURL() + ", " + "szTitle = " + szTitle + ", " + "szText = " + szText + ", " + "szControl = " + szControl);
        Vector<Object> params = new Vector<>();
        params.addElement(Marshal.serialize(szTitle));
        params.addElement(Marshal.serialize(szText));
    ...
    @Override
    public int winSetState(String szTitle, String szText, long nFlags) throws XmlRpcException, IOException {
    ...
    @Override
    public int winExists(String szTitle, String szText) throws XmlRpcException, IOException {
        Agent.log.info(">> " + "agent = " + agent.getURL() + ", " + "szTitle = " + szTitle + ", " + "szText = " + szText);
        Vector<Object> params = new Vector<>();
        params.addElement(Marshal.serialize(szTitle));
        params.addElement(Marshal.serialize(szText));
    ...
    @Override
    public int controlGetPosX(String szTitle, String szText, String szControl) throws XmlRpcException, IOException {
        Agent.log.info(">> " + "agent = " + agent.getURL() + ", " + "szTitle = " + szTitle + ", " + "szText = " + szText + ", " + "szControl = " + szControl);
        Vector<Object> params = new Vector<>();
        params.addElement(Marshal.serialize(szTitle));
        params.addElement(Marshal.serialize(szText));
    ...
    @Override
    public int controlGetPosY(String szTitle, String szText, String szControl) throws XmlRpcException, IOException {
        Agent.log.info(">> " + "agent = " + agent.getURL() + ", " + "szTitle = " + szTitle + ", " + "szText = " + szText + ", " + "szControl = " + szControl);
        Vector<Object> params = new Vector<>();
        params.addElement(Marshal.serialize(szTitle));
        params.addElement(Marshal.serialize(szText));
    ...
    @Override
    public String controlTreeView(String szTitle, String szText, String szControl, String szCommand, String szExtra1, String szExtra2) throws XmlRpcException, IOException {
        Agent.log.info(">> " + "agent = " + agent.getURL() + ", " + "szTitle = " + szTitle + ", " + "szText = " + szText + ", " + "szControl = " + szControl + ", " + "szCommand = " + szCommand + ", " + "szExtra1 = " + szExtra1 + ", " + "szExtra2 = " + szExtra2);
        Vector<Object> params = new Vector<>();
        params.addElement(Marshal.serialize(szTitle));
        params.addElement(Marshal.serialize(szText));
        params.addElement(Marshal.serialize(szControl));
    ...
    @Override
    public int winWait(String szTitle, String szText, long nTimeout) throws XmlRpcException, IOException {
        Agent.log.info(">> " + "agent = " + agent.getURL() + ", " + "szTitle = " + szTitle + ", " + "szText = " + szText + ", " + "nTimeout = " + nTimeout);
        Vector<Object> params = new Vector<>();
        params.addElement(Marshal.serialize(szTitle));
        params.addElement(Marshal.serialize(szText));
    ...
    @Override
    public int winGetPosX(String szTitle, String szText) throws XmlRpcException, IOException {
        Agent.log.info(">> " + "agent = " + agent.getURL() + ", " + "szTitle = " + szTitle + ", " + "szText = " + szText);
        Vector<Object> params = new Vector<>();
        params.addElement(Marshal.serialize(szTitle));
        params.addElement(Marshal.serialize(szText));
    ...
    @Override
    public int winGetPosY(String szTitle, String szText) throws XmlRpcException, IOException {
        Agent.log.info(">> " + "agent = " + agent.getURL() + ", " + "szTitle = " + szTitle + ", " + "szText = " + szText);
        Vector<Object> params = new Vector<>();
        params.addElement(Marshal.serialize(szTitle));
        params.addElement(Marshal.serialize(szText));
    ...
    @Override
    public int winGetPosHeight(String szTitle, String szText) throws XmlRpcException, IOException {
        Agent.log.info(">> " + "agent = " + agent.getURL() + ", " + "szTitle = " + szTitle + ", " + "szText = " + szText);
        Vector<Object> params = new Vector<>();
        params.addElement(Marshal.serialize(szTitle));
        params.addElement(Marshal.serialize(szText));
    ...
    @Override
    public int winGetPosWidth(String szTitle, String szText) throws XmlRpcException, IOException {
        Agent.log.info(">> " + "agent = " + agent.getURL() + ", " + "szTitle = " + szTitle + ", " + "szText = " + szText);
        Vector<Object> params = new Vector<>();
        params.addElement(Marshal.serialize(szTitle));
        params.addElement(Marshal.serialize(szText));
