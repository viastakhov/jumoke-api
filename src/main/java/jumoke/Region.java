...
public class Region implements IRegion {
	 ...
	 */
	public int h;
	//private org.sikuli.script.Region region = null;
	...
	Region(XmlRpcClient agent, int x, int y, int w, int h) throws XmlRpcException, IOException {
		...
		//*String reg = (String) agent.execute("Sikuli.getRegion", params);
		sXRegion = (String) agent.execute("Sikuli.getRegion", params);
		//*this.region = (org.sikuli.script.Region) Marshal.deserialize(reg);
	...
	public <PSRML> int click(PSRML target) throws Exception {
		...
		Vector<Object> params = new Vector<>();
		//*params.addElement(Marshal.serialize(region));
